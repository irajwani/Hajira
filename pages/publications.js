...
const POSTS = [
    ...
    { title: 'Justin Bibis: From a viral video to Pakistan’s Coke Studio stars', publication: 'AlJazeera', date: '07/04/2022', link: 'https://www.aljazeera.com/features/2022/4/7/justin-bibis-from-a-viral-video-to-pakistans-coke-studio-stars'},
    ...
    { title: 'Shaheen Shah Afridi: From Landi Kotal to top of cricketing world', publication: 'AlJazeera', date: '22/02/2022', link: 'https://www.aljazeera.com/sports/2022/2/22/shaheen-shah-afridi-from-landi-kotal-to-worlds-best'},
...
const BOOKS = [
    ...
    { title: 'Reporting War and Conflict in the 21st Century', date: '14/06/2019', link: 'https://researchcentre.trtworld.com/featured/reporting-war-and-conflict-in-the-21st-century/'},
];
    ...
    <div className="flex flex-col">
        ...
        {HEADERS.map((header, index) => (
            <p onClick={() => setHeader(header)} 
                className={`flex items-center justify-center pb-4 px-4 text-md md:text-lg ${chosenHeader === header ? 'border-b-2' : undefined} border-brown cursor-pointer`}
            >
                {header}
            </p>
        ))}
